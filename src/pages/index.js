...
function Navbar() {
  ...
  >
    ...
    <span>Contact</span>
      ...
      {/* Mobile Menu */}
      {menuOpen && (
        <div className="absolute top-20 left-0 w-full bg-gray-900 flex flex-col gap-6 p-6 md:hidden text-gray-300">
          <a
            href="#about"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="px-6 py-2 border border-gray-500 rounded-xl hover:border-purple-400 hover:text-purple-400 transition-all"
          >
            Resume
          </a>
        </div>
...
export default function Home() {
 ...
 <div className="fixed right-8 bottom-0 flex flex-col items-center gap-6 text-gray-400">
...
<a href="mailto:alihassanlodhi@gmail.com" className="cursor-pointer">
  ...
  <div className="w-[1px] h-24 bg-gray-500"></div>
      ...
      <div className="max-w-4xl">
       ...
       <h2 className="text-gray-400 text-lg font-light tracking-[0.12em] mb-3">
  Hi <span className="text-purple-500 font-normal">116.71.12.113</span>, my name is
</h2>


        <h1 className="text-[80px] font-bold leading-[1.1] text-[#d1d5db]">
          Ali Hassan Lodhi.
        </h1>

        <h2 className="text-[60px] font-semibold text-[#9ca3af] leading-[1.1] mt-3">
  ...
  className="mt-10 border border-gray-500 px-8 py-4 rounded-lg text-gray-300 hover:bg-gray-200 hover:text-black transition"
>
  Check out my work →
</button>
      </div>
...
{/* ABOUT SECTION */}
<section id="about" className="px-20 py-32 max-w-4xl mx-auto">
...
custom logic for each module and the frontend shall access those rest APIs and get the data and show it to the user.</p>
    ...
    {/* NUML */}
    <div>
      <h3 className="text-2xl font-semibold text-purple-400">NUML</h3>
...
<section id="projects" className="py-32 px-6 md:px-20 bg-[#0c0c0c]">
  ...
  {previewIndex !== null && (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-md flex items-center justify-center z-[999]">
      ...
      {/* LEFT ARROW */}
      <button
        className="text-white text-4xl px-4 py-2 absolute left-10 bg-black/50 hover:bg-black/80 rounded-full"
        onClick={(e) => {
          e.stopPropagation();
          setPreviewIndex((previewIndex - 1 + previewList.length) % previewList.length);
        }}
      >
        ←
      </button>
      ...
      {/* RIGHT ARROW */}
      <button
        className="text-white text-4xl px-4 py-2 absolute right-10 bg-black/50 hover:bg-black/80 rounded-full"
        onClick={(e) => {
          e.stopPropagation();
          setPreviewIndex((previewIndex + 1) % previewList.length);
        }}
      >
        →
      </button>
